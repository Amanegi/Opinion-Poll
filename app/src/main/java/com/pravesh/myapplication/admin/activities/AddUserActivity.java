...
public class AddUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnBack = findViewById(R.id.btnBackAU);
        btnAdd = findViewById(R.id.btnAddAU);
        adminRv = findViewById(R.id.userRecycler);
        contentFrame = findViewById(R.id.contentFrameAU);
        fetchingFrame = findViewById(R.id.fetchingFrameAU);
        fetchingAnim = findViewById(R.id.fetchingAnimAU);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AddUserActivity.this, AdminDashboardActivity.class));
            }
        });
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                builder = new AlertDialog.Builder(AddUserActivity.this);
                    ...
                    public void onClick(View v) {
                        ...
                        if (!name.equals("") && !phone.equals("") && !houseNo.equals("")) {
                            if (phone.length() == 10) {
                                ...
                                FancyToast.makeText(AddUserActivity.this, "Enter a valid phone number", FancyToast.LENGTH_LONG
                                        , FancyToast.ERROR, false).show();

                        } else {
                            FancyToast.makeText(AddUserActivity.this, "Empty fields not allowed", FancyToast.LENGTH_LONG
                                    , FancyToast.ERROR, false).show();
                        }
    ...
    public BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dialog.dismiss();
                    final CustomDialog confirmationDialog = new CustomDialog(AddUserActivity.this);
                    ...
                    confirmationDialog.setPositiveListener(new CustomDialogListener() {
                        ...
                        public void onClick() {
                            ...
                            database.collection(Constants.DATABASE_USER).document(phone)
                                    .delete()
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            FancyToast.makeText(AddUserActivity.this, "Deleted", FancyToast.LENGTH_SHORT
                                                    , FancyToast.ERROR, false).show();
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            FancyToast.makeText(AddUserActivity.this, "Error while deleting", FancyToast.LENGTH_SHORT
                                                    , FancyToast.ERROR, false).show();
                                        }
                                    });
                        }
    ...
    private void editAdmin(final String name, final String phone, final String houseNo, String addedBy, final int position) {
        ...
        database.collection(Constants.DATABASE_USER).document(phone).set(admin).
                addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        ...
                        adminAdapter.notifyDataSetChanged();
                        FancyToast.makeText(AddUserActivity.this, "Edited", FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, false)
                                .show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                FancyToast.makeText(AddUserActivity.this, "Failure: " + e.getMessage(), FancyToast.LENGTH_LONG, FancyToast.ERROR, false)
                        .show();
            }
        });
    }
        ...
        database.collection(Constants.DATABASE_USER).document(phone).set(admin).
                addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        adminList.add(admin1);
                        adminAdapter.notifyDataSetChanged();
                        FancyToast.makeText(AddUserActivity.this, "Added", FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, false)
                                .show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
    ...
    private void fetchAdmins() {
        database.collection(Constants.DATABASE_USER)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            adminRv.setLayoutManager(new LinearLayoutManager(AddUserActivity.this));
                            ...
                            adminAdapter = new AdminAdapter(AddUserActivity.this, adminList);
                            adminRv.setAdapter(adminAdapter);
                            fetchingFrame.setVisibility(View.GONE);
                            contentFrame.setVisibility(View.VISIBLE);
                            fetchingAnim.cancelAnimation();
                        } else {
                            FancyToast.makeText(AddUserActivity.this, "Error getting list of admins", FancyToast.LENGTH_SHORT,
